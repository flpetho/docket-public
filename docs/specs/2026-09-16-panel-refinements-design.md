...
`trello · a1b2c3d4 · This month · https://trello.com/c/a1b2c3d4` (62 characters, a URL) into a field
...
- **Bridge:** `docket_add` gains `origin`, described as *a short provenance line: channel · id · date,
  and a link if there is one — e.g. `trello · a1b2c3d4 · https://trello.com/c/a1b2c3d4`. Shown in the
