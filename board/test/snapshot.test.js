...
test('a note-less card with an origin marks it on the face so the CSS can keep it to one line', () => {
  const html = render([card({ origin: 'trello · d3g87DtJ · This month · https://trello.com/c/d3g87DtJ' })])
  assert.ok(html.includes('<span class="origin">trello · d3g87DtJ · This month · https://trello.com/c/d3g87DtJ</span>'))
