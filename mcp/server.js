  ...
  'docket_add',
  {
    ...
    inputSchema: {
      ...
      origin: z
        ...
        .optional()
        .describe(
          'A short provenance line — channel · id · date, and a link if there is one, e.g. "trello · d3g87DtJ · https://trello.com/c/d3g87DtJ". Shown in the panel\'s Source row and on the card face. Source metadata belongs here, never in a note.',
        ),
    },
  },
